...
// Ojo de Horus + circuito, en SVG (hereda el color con currentColor).
function EyeMark({ size = 34, stroke = 2.3, className = "eyemark" }) {
  return (
    <svg
      className={className}
      width={size}
      ...
      aria-hidden="true"
    >
      <path d="M50 5 L86 18 V53 C86 83 50 104 50 104 C50 104 14 83 14 53 V18 Z" strokeWidth={stroke + 0.7} />
      <path d="M27 39 C42 29 60 29 75 38" />
      <path d="M29 50 C42 39 61 39 73 48 C61 59 42 59 29 50 Z" />
      <circle cx="51" cy="49" r="5.2" fill="currentColor" stroke="none" />
      <path d="M61 56 C64 66 67 75 71 84" />
      <path d="M41 57 C33 63 37 74 46 71 C53 69 50 60 45 62" />
      <path d="M29 47 H22" />
      <path d="M31 62 H25 V70" />
      <circle cx="25" cy="72" r="2.3" fill="currentColor" stroke="none" />
      <path d="M55 64 H63 V73" />
      <circle cx="63" cy="75" r="2.3" fill="currentColor" stroke="none" />
      <path d="M40 78 V85" />
      <circle cx="40" cy="87" r="2.3" fill="currentColor" stroke="none" />
      <path d="M75 45 H82" />
      <circle cx="84" cy="45" r="2.3" fill="currentColor" stroke="none" />
      <circle cx="20" cy="47" r="2.3" fill="currentColor" stroke="none" />
    </svg>
  );
}
  ...
  return (
    <>
      ...
      <header className="hero" id="top">
        <EyeMark className="eyemark hero-watermark" size={520} stroke={1.3} />
